      ...
      {loading ? (
        ...
        <Fragment>
          ...
          <div className="container" id="sectionOne">
            <h2 className="mt-5 mb-5 text-center">My profile</h2>
            <div className="row justify-content-around ">
              <div className="col-12 col-md-3 mb-3 d-flex flex-column justify-content-center ">
                <figure className=" avatar-profile my-5 align-self-center">
                  <img
